...
public class CategoryAcceptanceTest extends AcceptanceTest {
    ...
    void registerSubCategory() {
        ...
        final ExtractableResponse<Response> responseExtractableResponse = CategoryAcceptanceSteps.registerSub(SUB_NAME, SUB_ORDER, 메인카테고리_아이디, accessToken);
        CategoryAcceptanceSteps.validateSubCategory(responseExtractableResponse);
    }
