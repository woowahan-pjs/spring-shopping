...
class AuthControllerTest {
    ...
    class register {
            ...
            class email {
                ...
                void invalidEmail() throws Exception {
                    ...
                    mockMvc.perform(post("/api/members/register")
                            ...
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("유효한 이메일 형식이 아닙니다.")));
                }
                ...
                void isNull(final String input) throws Exception {
                    ...
                    mockMvc.perform(post("/api/members/register")
                                    ...
                                    .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("이메일은 필수 입력 값입니다.")));
                }
                ...
                void isMin() throws Exception {
                    ...
                    mockMvc.perform(post("/api/members/register")
                                    ...
                                    .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("이메일은 최소 5자에서 최대 320자 까지 입력 가능합니다.")));
                }
            ...
            class password {
                ...
                void isMin() throws Exception {
                    ...
                    mockMvc.perform(post("/api/members/register")
                                    ...
                                    .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("비밀번호는 최소 8자에서 최대 100자 까지 입력 가능합니다.")));
                }
                ...
                void isNull(final String input) throws Exception {
                    ...
                    mockMvc.perform(post("/api/members/register")
                                    ...
                                    .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("비밀번호는 필수 입력 값입니다.")));
                }
            ...
            class role {
                ...
                void isInvalid() throws Exception {
                    ...
                    mockMvc.perform(post("/api/members/register")
                                    ...
                                    .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("권한은 필수 입력 값입니다.")));
                }
        ...
        void success() throws Exception {
            ...
            // when
            final MvcResult mvcResult = mockMvc.perform( post("/api/members/register")
                            .content(requestBody)
                            .contentType(MediaType.APPLICATION_JSON))
            ...
            final RegisterResponse response =
                    ConverterHelper.toDto(mvcResult.getResponse().getContentAsString(), RegisterResponse.class);
    ...
    class login {
        ...
        void success() throws Exception {
            ...
            // when
            final MvcResult mvcResult = mockMvc.perform(post("/api/members/login")
                            .content(requestBody)
                            .contentType(MediaType.APPLICATION_JSON))
                    .andExpect(MockMvcResultMatchers.status().isOk())
                    .andReturn();
            ...
            final LoginResponse response =
                    ConverterHelper.toDto(mvcResult.getResponse().getContentAsString(), LoginResponse.class);
