...
class ProductControllerTest {
    ...
    class getProduct {
        ...
        class validate {
            ...
            class productId {
                ...
                void isMin() throws Exception {
                    ...
                    mockMvc.perform(get("/api/products/{productId}", productId))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("상품 고유 ID는 0보다 큰 값이여야 합니다.")));
                }
            }
        }
        ...
        void notFound() throws Exception {
            ...
            given(productService.getProduct(productId)).willThrow(new ShoppingBusinessException("상품이 존재하지 않습니다."));
        ...
        void success() throws Exception {
            ...
            final ProductResponse expectedResponse = new ProductResponse(productId, name, price, imageUrl);

            given(productService.getProduct(productId)).willReturn(expectedResponse);

            // when
            final MvcResult mvcResult = mockMvc.perform(get("/api/products/{productId}", productId))
                    .andExpect(MockMvcResultMatchers.status().isOk())
                    .andReturn();

            final ProductResponse response =
                    ConverterHelper.toDto(mvcResult.getResponse().getContentAsString(), ProductResponse.class);
    ...
    class registerProduct {
            ...
            class name {
                ...
                void isNull(final String input) throws Exception {
                    ...
                    mockMvc.perform(post("/api/products")
                            ...
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("상품명은 필수 입력 값입니다.")));
                }
                ...
                void isMin() throws Exception {
                    ...
                    mockMvc.perform(post("/api/products")
                                    ...
                                    .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("상품명은 최소 5자에서 최대 15자 까지 입력 가능합니다.")));
                }
                ...
                void invalidPattern(final String input) throws Exception {
                    ...
                    mockMvc.perform(post("/api/products")
                                    ...
                                    .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("특수문자는 (, ), [, ], &, -, +, /, _`만 가능합니다.")));
                }
            }
            ...
            class price {
                ...
                void isMin() throws Exception {
                    ...
                    mockMvc.perform(post("/api/products")
                                    ...
                                    .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("가격은 1원 이상만 가능합니다.")));
                }
                ...
                void isMax() throws Exception {
                    ...
                    mockMvc.perform(post("/api/products")
                                    ...
                                    .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("가격은 99999999999원 이하만 가능합니다.")));
                }
            }
            ...
            class imageUrl {
                ...
                void isNull(final String input) throws Exception {
                    ...
                    mockMvc.perform(post("/api/products")
                                    ...
                                    .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("이미지 URL은 필수 입력 값입니다.")));
                }
                ...
                void isMin() throws Exception {
                    ...
                    mockMvc.perform(post("/api/products")
                                    ...
                                    .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath(  "$.parameters[*].message", hasItem("이미지 URL은 최소 9자에서 최대 255자 까지 입력 가능합니다.")));
                }
                ...
                void invalidUrl() throws Exception {
                    ...
                    mockMvc.perform(post("/api/products")
                                    .content(requestBody)
                                        .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("http:// 또는 https:// 형식만 입력 가능합니다.")));
                }
            }
        }
        ...
        void profanityIsTrue() throws Exception {
            ...
            given(productService.registerProduct(userId, ConverterHelper.toDto(requestBody, ProductSaveRequest.class)))
    ...
    class modifyProduct {
            ...
            class name {
                ...
                void isNull(final String input) throws Exception {
                    ...
                    mockMvc.perform(put("/api/products/{productId}", productId)
                                    ...
                                    .contentType(MediaType.APPLICATION_JSON))
                            .andExpect(MockMvcResultMatchers.status().isBadRequest())
                            .andExpect(jsonPath("$.parameters[*].message", hasItem("상품명은 문자/숫자/공백과 특수문자 (, ), [, ], &, -, +, /, _, , 만 입력 가능하며 공백만은 불가합니다.")));
                }
        ...
        @Test
        @WithAuthUser(role = Role.ADMIN)
        @DisplayName("상품이 존재하지 않으면 외가 발생합니다.")
        void notFound() throws Exception {
            // given
            final Long userId = 1L;
            final Long productId = 3L;
            ...
            willThrow(new NotFoundProductException())
                    .given(productService).modifyProduct(userId, productId, ConverterHelper.toDto(requestBody, ProductUpdateRequest.class));
    ...
    class search {
        ...
        void success() throws Exception {
            ...
            final ProductSearchRequest request = new ProductSearchRequest(name, Price.create(3000L), null);
