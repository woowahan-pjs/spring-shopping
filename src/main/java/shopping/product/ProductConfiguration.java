...
public class ProductConfiguration {
    ...
    @Bean
    public CreateProduct createProduct(ProductRepository productRepository, ProfanityChecker profanityChecker) {
    ...
    @Bean
    public UpdateProduct updateProduct(ProductRepository productRepository, ProfanityChecker profanityChecker) {
