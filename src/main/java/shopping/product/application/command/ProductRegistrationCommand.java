...
public record ProductRegistrationCommand(
    ...
    public ProductRegistrationCommand(final String name, final long amount, final String thumbnailImageUrl, final long subCategoryId, final long shopId, final long sellerId) {
        this.name = name;
        this.amount = amount;
