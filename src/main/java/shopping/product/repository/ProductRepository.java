...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @QueryHints(@QueryHint(name = "org.hibernate.comment", value = "ProductRepository.findProductByIdAndIsUse : 활성화 되어 있는 상품을 조회합니다."))
    Optional<Product> findProductByIdAndIsUse(final Long id, final Boolean isUse);

    @QueryHints(@QueryHint(name = "org.hibernate.comment", value = "ProductRepository.findProductByIdAndUserIdAndIsUse : 특정 회원의 활성화 되어 있는 상품을 조회합니다."))
    ...
    @QueryHints(@QueryHint(name = "org.hibernate.comment", value = "ProductRepository.search : 등록된 상품을 검색합니다."))
    Page<Product> search(
    ...
    @QueryHints(@QueryHint(name = "org.hibernate.comment", value = "ProductRepository.findByIsUseAndIdIn : 활성화되어 있는 특정 ID의 상품을 조회합니다."))
