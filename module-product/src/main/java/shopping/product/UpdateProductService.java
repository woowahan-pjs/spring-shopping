...
public class UpdateProductService implements UpdateProduct {
    ...
    public UpdateProductService(ProductRepository productRepository, ProfanityChecker profanityChecker) {
    ...
    public Product execute(Long id, Product product) {
        ...
        Product updated = new Product(id, product.getName(), product.getPrice(), product.getImageUrl());
